...
export default function EducatorStep1Resume(props: { firstName: string; resumeUrl: string }) {
	return (
		<Html>
			<Head />
			<Preview>Resume your Bee Bright application</Preview>
			<Body style={{ fontFamily: "ui-sans-serif, system-ui", color: "#0f172a" }}>
				<Container style={{ maxWidth: 560, padding: 24 }}>
					...
					<Section>
						<Text>
							Thanks for starting your application with {SITE.shortName} Staffing. You can finish it now
						...
						<Text style={{ fontSize: 12, color: "#475569" }}>
							...
							contact us at {SITE.emailRecruitment}.
						</Text>
					</Section>
				</Container>
			</Body>
